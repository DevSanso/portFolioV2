...
class AboutMeView extends Component {
    public render() {
        return (
            <div data-aos="fade-down"  view-about-me="">
                <h3 data-aos="fade-right" data-aos-duration="500" className="view-about-me_title">저는 이러한 사람입니다.</h3>
                ...
                <section>
                    <h3 data-aos="fade-right" data-aos-duration="1000" className="view-about-me_title">성격에 대한 이야기</h3>
                    <SimpleBar style={{maxHeight:"100px"}}>
                        <p data-aos="zoom-in" data-aos-duration="2000" className="view-about-me_p">
                    ...
                    <h3 data-aos="fade-right" data-aos-duration="1000" className="view-about-me_title">개발자로써</h3>
